...
def create_market_data_record(
    symbol: str, timestamp: datetime, price_base: float = 100.0
) -> dict[str, Any]:
...
def create_market_data_batch(
    symbols: list[str], start_date: datetime, end_date: datetime, interval_minutes: int = 60
) -> list[dict[str, Any]]:
...
def create_news_record(
    symbol: str, timestamp: datetime, source: str = "test_source"
) -> dict[str, Any]:
...
def create_social_sentiment_record(
    symbol: str, timestamp: datetime, platform: str = "reddit"
) -> dict[str, Any]:
