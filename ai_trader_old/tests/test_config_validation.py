...
class TestConfigValidationModels:
    ...
    def test_valid_minimal_config(self):
        ...
        config_dict = {
            ...
            "api_keys": {"alpaca": {"key": "test_key", "secret": "test_secret"}},
        }
    ...
    def test_position_size_validation(self):
        ...
        config_dict = {
            "system": {"environment": "paper"},
            "api_keys": {"alpaca": {"key": "test_key", "secret": "test_secret"}},
            "risk": {"position_sizing": {"max_position_size": 15.0}},  # Too high (>10%)
        }
    ...
    def test_risk_percentage_validation(self):
        ...
        config_dict = {
            "system": {"environment": "paper"},
            "api_keys": {"alpaca": {"key": "test_key", "secret": "test_secret"}},
            "risk": {"circuit_breaker": {"daily_loss_limit": 60.0}},  # Too high (>50%)
        }
    ...
    def test_macd_periods_validation(self):
        ...
        config_dict = {
            ...
            "api_keys": {"alpaca": {"key": "test_key", "secret": "test_secret"}},
            "features": {
                "technical_indicators": {"macd_fast": 30, "macd_slow": 20}  # Should be < slow
            },
        }
    ...
    def test_environment_consistency_validation(self):
        ...
        config_dict = {
            "system": {"environment": "paper"},
            "api_keys": {"alpaca": {"key": "test_key", "secret": "test_secret"}},
            "broker": {"paper_trading": False},  # Inconsistent with paper environment
        }
    ...
    def test_env_var_substitution(self):
        ...
        config_dict = {
            "system": {"environment": "paper"},
            "api_keys": {"alpaca": {"key": "${TEST_API_KEY}", "secret": "test_secret"}},
        }
    ...
    def test_missing_env_var_validation(self):
        ...
        config_dict = {
            "system": {"environment": "paper"},
            "api_keys": {"alpaca": {"key": "${MISSING_API_KEY}", "secret": "test_secret"}},
        }
    ...
    def test_environment_overrides(self):
        ...
        config_dict = {
            "system": {"environment": "paper"},
            "api_keys": {"alpaca": {"key": "test_key", "secret": "test_secret"}},
            "risk": {"position_sizing": {"max_position_size": 5.0}},
            "environments": {"paper": {"risk": {"position_sizing": {"max_position_size": 10.0}}}},
        }
...
"""
    ...
    def test_strict_mode_warnings(self):
        ...
        config_dict = {
            ...
            "api_keys": {"alpaca": {"key": "test_key", "secret": "test_secret"}},
            "broker": {"paper_trading": True},  # Warning in live mode
        }
...
class TestRealWorldScenarios:
    ...
    def test_production_config_validation(self):
        ...
        config_dict = {
            "system": {"environment": "live"},
            "api_keys": {
                "alpaca": {"key": "AKFZ...", "secret": "xyz123..."},
                "polygon": {"key": "poly_key"},
            },
            "broker": {"paper_trading": False},
            "risk": {
                "position_sizing": {"max_position_size": 2.0},
                "circuit_breaker": {"daily_loss_limit": 3.0},
            },
            "data": {"sources": ["alpaca", "polygon"]},
        }
    ...
    def test_paper_trading_config_validation(self):
        ...
        config_dict = {
            "system": {"environment": "paper"},
            "api_keys": {"alpaca": {"key": "paper_key", "secret": "paper_secret"}},
            "broker": {"paper_trading": True},
            "risk": {"position_sizing": {"max_position_size": 10.0}},
        }
    ...
    def test_training_config_validation(self):
        ...
        config_dict = {
            ...
            "api_keys": {"alpaca": {"key": "training_key", "secret": "training_secret"}},
            "training": {
