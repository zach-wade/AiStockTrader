...
class TestResilienceConfig:
    ...
    def test_custom_config(self):
        ...
        config = ResilienceConfig(max_retries=5, failure_threshold=10, critical_latency_ms=2000.0)
...
class TestResilienceStrategies:
    ...
    def test_init_with_dict(self):
        ...
        config_dict = {"max_retries": 4, "failure_threshold": 8, "critical_latency_ms": 3000.0}
    ...
    def test_circuit_breaker_integration(self):
        ...
        config = ResilienceConfig(
            failure_threshold=7, recovery_timeout=30.0, critical_latency_ms=4000.0
        )
        rs = ResilienceStrategies(config)
    ...
    def test_error_recovery_integration(self):
        ...
        config = ResilienceConfig(
            max_retries=5, initial_delay=0.5, backoff_factor=1.5, max_delay=30.0
        )
        rs = ResilienceStrategies(config)
...
class TestEdgeCases:
    ...
    def test_config_with_none_values(self):
        ...
        config = {"max_retries": None, "failure_threshold": 10}
