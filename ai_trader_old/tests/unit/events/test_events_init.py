...
class TestEventsInit:
    ...
    def test_all_list_completeness(self):
        ...
        expected_exports = {
            ...
            "get_scanner_feature_bridge",
            "initialize_scanner_feature_bridge",
            "cleanup_scanner_feature_bridge",
            "is_bridge_running",
            "restart_scanner_feature_bridge",
            "get_bridge_stats",
        }
    ...
    def test_circular_import_safety(self):
        ...
        # Local imports
        from main.events import Event, EventBus, ScannerFeatureBridge
