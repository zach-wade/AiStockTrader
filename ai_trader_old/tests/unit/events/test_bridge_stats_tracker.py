...
class TestBridgeStatsTracker:
    ...
    def tracker(self, mock_metrics_collector):
        ...
        with patch(
            "main.events.handlers.scanner_bridge_helpers.bridge_stats_tracker.MetricsCollector"
        ) as mock_class:
    ...
    def test_increment_alerts_received(self, tracker, mock_metrics_collector):
        ...
        with patch(
            "main.events.handlers.scanner_bridge_helpers.bridge_stats_tracker.record_metric"
        ) as mock_record:
            ...
            mock_record.assert_called_once_with("scanner_bridge.alerts_received", 1)
    ...
    def test_increment_feature_requests_sent(self, tracker, mock_metrics_collector):
        ...
        with patch(
            ...
            # Should record metric
            mock_record.assert_called_once_with("scanner_bridge.feature_requests_sent", 1)
    ...
    def test_add_symbol_processed_new_symbol(self, tracker, mock_metrics_collector):
        ...
        with patch(
            ...
            mock_record.assert_called_once_with(
                "scanner_bridge.symbol_processed", 1, tags={"symbol": "AAPL"}
            )
    ...
    def test_add_symbol_processed_duplicate_symbol(self, tracker, mock_metrics_collector):
        ...
        with patch(
            ...
            mock_record.assert_called_once_with(
                "scanner_bridge.symbol_processed", 1, tags={"symbol": "GOOGL"}
            )
    ...
    def test_get_stats_empty(self, tracker, mock_metrics_collector):
        ...
        mock_metrics_collector.get_metric_stats.assert_any_call(
            "scanner_bridge.feature_requests_sent"
        )
