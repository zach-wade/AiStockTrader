...
class TestFeatureGroupMapper:
    ...
    def custom_config(self):
        ...
        return {
            "group_configs": {"PRICE": {"priority_boost": 2}},
            "alert_mappings": {"CUSTOM_ALERT": ["PRICE", "VOLUME"]},
        }
    ...
    def test_map_alert_to_features_known_type(self, mapper):
        ...
        alert = create_scan_alert(alert_type=AlertType.HIGH_VOLUME, score=0.7)
    ...
    def test_map_alert_to_features_unknown_type(self, mapper):
        ...
        alert = create_scan_alert(alert_type=AlertType.UNKNOWN, score=0.5)
    ...
    def test_conditional_groups_volume_spike(self, mapper):
        ...
        alert = create_scan_alert(data={"volume_multiplier": 5.0})
    ...
    def test_conditional_groups_news_keywords(self, mapper):
        ...
        alert = create_scan_alert(data={"keywords": ["earnings", "revenue"]})
    ...
    def test_priority_calculation_base(self, mapper):
        ...
        ml_alert = create_scan_alert(alert_type=AlertType.ML_SIGNAL, score=0.5)
        ml_request = mapper.map_alert_to_features(ml_alert)

        # Unknown should have low base priority
        unknown_alert = create_scan_alert(alert_type=AlertType.UNKNOWN, score=0.5)
    ...
    def test_priority_calculation_volatility_boost(self, mapper):
        ...
        normal_alert = create_scan_alert(data={"volatility_level": "normal"})
        extreme_alert = create_scan_alert(data={"volatility_level": "extreme"})
    ...
    def test_priority_bounds(self, mapper):
        ...
        alert = create_scan_alert(
            alert_type=AlertType.ML_SIGNAL, score=1.0, data={"volatility_level": "extreme"}
        )
    ...
    def test_configuration_override(self, mapper):
        ...
        custom_config = {"alert_mappings": {"HIGH_VOLUME": ["MICROSTRUCTURE", "ORDER_FLOW"]}}
