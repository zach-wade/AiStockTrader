...
class TestFeatureConfigLoading:
    ...
    def sample_yaml_config(self):
        ...
        return {
            ...
            "priority_rules": {
                "base_priorities": {"ML_SIGNAL": 8, "BREAKOUT": 7},
    ...
    def sample_json_config(self):
        ...
        return {
            "feature_groups": {
                "MOMENTUM": {"features": ["rsi", "macd"], "dependencies": ["PRICE"]}
            },
            "version": "1.0",
        }
    ...
    def test_load_config_with_includes(self, sample_yaml_config):
        ...
        main_config = {
            ...
            "feature_groups": {"CUSTOM": {"features": ["custom1"]}},
        }

        base_config = {"feature_groups": sample_yaml_config["feature_groups"]}

        override_config = {"feature_groups": {"PRICE": {"priority_boost": 5}}}  # Override
                ...
                final_config = {
                    "feature_groups": {
                        **base_config["feature_groups"],
                        "PRICE": {**base_config["feature_groups"]["PRICE"], "priority_boost": 5},
    ...
    def test_config_validation_on_load(self, sample_yaml_config):
        ...
        invalid_config = {"feature_groups": {"INVALID": "not a dict"}}  # Should be dict
    ...
    def test_config_inheritance(self):
        ...
        base_config = {
            "feature_groups": {"BASE": {"features": ["base1", "base2"], "priority_boost": 1}},
            "global_settings": {"cache_ttl": 300},
        }

        child_config = {
            "extends": "base_config.yaml",
            "feature_groups": {"CHILD": {"features": ["child1"], "inherits": "BASE"}},
        }
    ...
    def test_config_with_environment_substitution(self):
        ...
        with patch.dict(
            os.environ, {"PRICE_FEATURES": "open,high,low,close", "DB_HOST": "prod.db.com"}
        ):
