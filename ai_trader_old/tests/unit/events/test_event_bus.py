...
class TestEventBus:
    ...
    async def test_event_bus_initialization(self):
        ...
        config2 = EventBusConfig(
            max_queue_size=500, max_workers=5, enable_history=False, enable_dlq=False
        )
    ...
    async def test_circuit_breaker_integration(self):
        ...
        with patch("main.utils.resilience.get_circuit_breaker") as mock_get_cb:
            ...
            cb_config = CircuitBreakerConfig(failure_threshold=2, recovery_timeout=10)
            ...
            try:
                ...
                mock_get_cb.assert_called_once_with(
                    "event_bus", failure_threshold=2, recovery_timeout=10
                )
    ...
    async def test_dlq_integration(self):
        ...
        with patch(
            "main.events.event_bus_helpers.dead_letter_queue_manager.DeadLetterQueueManager"
        ) as mock_dlq:
