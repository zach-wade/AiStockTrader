...
class TestAlertFeatureMapper:
    ...
    def test_get_features_for_known_alert_type(self, mapper):
        ...
        with patch(
            "main.events.handlers.scanner_bridge_helpers.alert_feature_mapper.record_metric"
        ) as mock_metric:
            ...
            mock_metric.assert_called_once_with(
                ...
                1,
                tags={"alert_type": "HIGH_VOLUME", "is_default": False},
            )
    ...
    def test_get_features_for_unknown_alert_type(self, mapper):
        ...
        with patch(
            ...
            mock_metric.assert_called_once_with(
                "alert_feature_mapper.lookup",
                1,
                tags={"alert_type": "UNKNOWN_TYPE", "is_default": True},
            )
    ...
    def test_reload_config_custom_path(self, mapper):
        ...
        reload_config = {
            "alert_feature_mappings": {"RELOADED": ["reloaded_feature"]},
    ...
    def test_missing_required_fields(self):
        ...
        incomplete_config = {
            "alert_feature_mappings": {"HIGH_VOLUME": ["volume"]}
