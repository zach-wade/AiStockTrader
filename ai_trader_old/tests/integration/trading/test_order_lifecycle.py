...
from main.utils.exceptions import RiskLimitError
...
class TestOrderLifecycle:
    ...
    async def test_order_creation_and_validation(self, trading_engine, portfolio_tracker):
    ...
    async def test_order_execution_flow(self, trading_engine, portfolio_tracker):
    ...
    async def test_risk_limit_rejection(self, trading_engine, portfolio_tracker):
    ...
    async def test_order_cancellation(self, trading_engine):
    ...
    async def test_partial_fill_handling(self, trading_engine, portfolio_tracker):
    ...
    async def test_stop_loss_order_execution(self, trading_engine, portfolio_tracker):
    ...
    async def test_concurrent_order_processing(self, trading_engine, performance_threshold):
        ...
        order_tasks = [trading_engine.submit_order(req) for req in order_requests]
