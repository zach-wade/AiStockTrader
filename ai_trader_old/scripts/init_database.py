...
from ai_trader.utils.database import Base, get_db_engine
...
def create_tables():
    ...
    try:
        ...
        logger.error(f"Failed to create database tables: {e!s}")
        raise
...
def create_partitions():
    ...
    try:
        ...
        logger.warning(f"Failed to create partitions (may not be supported): {e!s}")
...
def create_views():
    ...
    try:
        ...
        logger.error(f"Failed to create views: {e!s}")
        raise
...
def insert_initial_data():
    ...
    try:
        ...
        logger.warning(f"Failed to insert initial data: {e!s}")
...
def main():
    ...
    try:
        ...
        print(f"\n❌ Database initialization failed: {e!s}")
        sys.exit(1)
