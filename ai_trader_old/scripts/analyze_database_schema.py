...
class PostgreSQLSchemaAnalyzer:
    ...
    def generate_sqlalchemy_column(self, col_info: dict[str, Any], is_primary: bool = False) -> str:
        ...
        elif data_type.startswith("character varying") or data_type == "varchar":
    ...
    def generate_models_code(self, tables_to_generate: list[str], analysis: dict[str, Any]) -> str:
        ...
        code_parts.append(
            "from sqlalchemy import Column, String, Integer, BigInteger, Float, Boolean, Date, DateTime, Text, JSON, ForeignKey, Index, Numeric, func"
        )
    ...
    def save_analysis_report(
        self, analysis: dict[str, Any], output_file: str = "schema_analysis.json"
    ):
