...
class DataWrittenEvent(Event):
    ...
    write_timestamp: datetime = field(default_factory=lambda: datetime.now(UTC))
    row_count: int = 0
...
class DataGapDetectedEvent(Event):
    ...
    gap_start: datetime = field(default_factory=lambda: datetime.now(UTC))
    gap_end: datetime = field(default_factory=lambda: datetime.now(UTC))
