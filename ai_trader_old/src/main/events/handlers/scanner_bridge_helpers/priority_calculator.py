...
class PriorityCalculator(ErrorHandlingMixin):
    ...
    def __init__(self, config_path: str | None = None):
        ...
        try:
            ...
            self.priority_config = config.get(
            ...
            self.priority_config = {"min_priority": 1, "max_priority": 10, "base_multiplier": 10}
    ...
    def calculate_priority(self, score: float, alert_type: str) -> int:
        ...
        record_metric(
            ...
            tags={"alert_type": alert_type, "has_boost": boost > 0, "boost_value": boost},
        )

        logger.debug(
            f"Calculated priority for alert '{alert_type}' (score {score:.2f}): {final_priority}."
        )
