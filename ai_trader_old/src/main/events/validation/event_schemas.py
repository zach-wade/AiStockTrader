...
SCHEMAS = {
    ...
    "SymbolQualified": {
        ...
        "properties": {
            "symbol": {"type": "string", "pattern": "^[A-Z]{1,5}$", "description": "Stock symbol"},
            "layer": {
                "type": "integer",
                "minimum": 0,
                "maximum": 3,
    ...
    "SymbolPromoted": {
        ...
        "properties": {
            ...
            "from_layer": {"type": "integer", "minimum": 0, "maximum": 3},
            "to_layer": {"type": "integer", "minimum": 0, "maximum": 3},
    ...
    "BackfillCompleted": {
        ...
        "properties": {
            "backfill_id": {"type": "string", "minLength": 1},
            "symbol": {"type": "string", "pattern": "^[A-Z]{1,5}$"},
    ...
    "DataGapDetected": {
        ...
        "properties": {
            ...
            "gap_size_hours": {"type": "number", "minimum": 0},
...
class EventSchemaValidator:
    ...
    def __init__(self, strict_mode: bool = False):
        ...
        # Statistics
        self._stats = {"validated": 0, "passed": 0, "failed": 0, "unknown_types": 0}
    ...
    def _format_validation_error(self, event_type: str, error: ValidationError) -> str:
        ...
        return f"Event type '{event_type}' validation failed at '{path}': " f"{error.message}"
