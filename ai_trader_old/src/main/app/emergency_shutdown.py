...
class EmergencyShutdown(ErrorHandlingMixin):
    ...
    def __init__(self, config: Any):
        ...
        self.register_error_callback(
            ...
            lambda error, context: record_metric(
                "shutdown_error", 1, tags={"context": context, "error_type": type(error).__name__}
            ),
        )
    ...
    async def _soft_shutdown(self, timeout: int) -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": "success", "level": "soft", "steps_completed": steps_completed}
    ...
    async def _normal_shutdown(self, timeout: int) -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": "success", "level": "normal", "steps_completed": steps_completed}
    ...
    async def _hard_shutdown(self, timeout: int) -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": "success", "level": "hard", "steps_completed": steps_completed}
