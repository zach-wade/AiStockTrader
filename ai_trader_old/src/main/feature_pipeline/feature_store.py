...
class FeatureStoreV2:
    ...
    def __init__(self, base_path: str, config: DictConfig | None = None):
        """
    ...
    def get_latest_features(self, symbol: str, feature_names: list[str] | None = None) -> pd.Series:
        """
    ...
    def get_date_range(self, symbol: str) -> tuple[datetime | None, datetime | None]:
