...
def calculate_exponential_average(series: pd.Series, span: int, adjust: bool = False) -> pd.Series:
    """
...
def calculate_weighted_average(
    series: pd.Series, weights: np.ndarray | None = None, window: int | None = None
) -> float | pd.Series:
    """
...
def calculate_rolling_std(
    series: pd.Series, window: int, min_periods: int | None = None, ddof: int = 1
) -> pd.Series:
    """
...
def calculate_rolling_quantile(
    series: pd.Series, window: int, quantile: float, min_periods: int | None = None
) -> pd.Series:
    """
...
def remove_outliers(series: pd.Series, method: str = "zscore", threshold: float = 3.0) -> pd.Series:
    """
...
def fit_distribution(data: pd.Series, distribution: str = "normal") -> dict[str, Any]:
    """
...
def calculate_correlation(
    series1: pd.Series, series2: pd.Series, method: str = "pearson", min_periods: int = 20
) -> float:
    """
...
def calculate_covariance(series1: pd.Series, series2: pd.Series, min_periods: int = 20) -> float:
    """
...
def normalize_series(
    series: pd.Series, method: str = "minmax", feature_range: tuple[float, float] = (0, 1)
) -> pd.Series:
    """
...
def calculate_entropy(series: pd.Series, bins: int = 10, method: str = "shannon") -> float:
    """
...
def calculate_hurst_exponent(series: pd.Series, lags: list[int] | None = None) -> float:
    """
