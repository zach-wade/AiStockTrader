...
from main.data_pipeline.services.ingestion import MetricExtractionConfig, MetricExtractionService
...
class FundamentalsFormatFactoryConfig:
    ...
    metric_extraction_config: MetricExtractionConfig | None = None
    format_handler_config: FormatHandlerConfig | None = None
    prefer_handler: str | None = None  # Force specific handler if set
...
class FundamentalsFormatFactory:
    ...
    def __init__(self, config: FundamentalsFormatFactoryConfig | None = None):
        """
        ...
        self.metric_extractor = MetricExtractionService(self.config.metric_extraction_config)
    ...
    def get_handler(self, data: Any, source: str | None = None) -> BaseFormatHandler | None:
        """
