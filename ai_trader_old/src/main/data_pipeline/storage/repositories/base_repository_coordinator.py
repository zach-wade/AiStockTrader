...
class BaseRepositoryCoordinator(
    IRepository, RepositoryMixin, DualStorageMixin, CacheMixin, MetricsMixin, ABC
):
    """
    ...
    async def get_aggregated_data(
        ...
        """
        return await self.query_processor.get_aggregated_data(query_filter, aggregation, group_by)
    ...
    async def _fallback_individual_upserts(self, records: list[dict[str, Any]]) -> OperationResult:
