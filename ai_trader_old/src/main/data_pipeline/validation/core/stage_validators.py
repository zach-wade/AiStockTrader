...
class IngestValidator:
    ...
    def __init__(self, market_data_validator: IMarketDataValidator, rule_engine: IRuleEngine):
    ...
    async def validate(self, data: Any, context: IValidationContext) -> IValidationResult:
        ...
        try:
            ...
            errors.append(f"Ingestion validation error: {e!s}")
...
class PostETLValidator:
    ...
    async def validate(self, data: Any, context: IValidationContext) -> IValidationResult:
        ...
        try:
            ...
            errors.append(f"Post-ETL validation error: {e!s}")
...
class FeatureReadyValidator:
    ...
    def __init__(self, feature_validator: IFeatureValidator, rule_engine: IRuleEngine):
    ...
    async def validate(self, data: Any, context: IValidationContext) -> IValidationResult:
        ...
        try:
            if not isinstance(data, pd.DataFrame) or data.empty:
                ...
                result = await self.feature_validator.validate_feature_dataframe(data, context)
                return result

        except Exception as e:
            errors.append(f"Feature-ready validation error: {e!s}")
