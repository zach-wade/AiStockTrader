...
class BaseActionProcessor(ABC):
    ...
    def __init__(
        ...
        config: ActionProcessorConfig | None = None,
    ):
        """
    ...
    def _create_base_record(
        self, ticker: str, ex_date: datetime | None, source: str, polygon_id: str | None = None
    ) -> dict[str, Any]:
        """
    ...
    def _extract_polygon_id(self, action: dict[str, Any]) -> str | None:
        """
