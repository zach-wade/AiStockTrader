...
class CorporateActionsService:
    ...
    def __init__(self, config: CorporateActionsConfig | None = None):
        """
    ...
    def map_frequency_to_int(self, frequency: Any) -> int | None:
        """
    ...
    def map_int_to_frequency(self, frequency: int | None) -> str | None:
        """
    ...
    def detect_action_type(self, action: dict[str, Any]) -> str | None:
        """
