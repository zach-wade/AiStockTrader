...
class QualificationService:
    ...
    def __init__(self, db_adapter: IAsyncDatabase, config: QualificationConfig | None = None):
        """
    ...
    async def get_qualifications_batch(self, symbols: list[str]) -> dict[str, SymbolQualification]:
        """
    ...
    async def _get_from_cache(self, symbol: str) -> SymbolQualification | None:
    ...
    async def _update_cache(self, symbol: str, qualification: SymbolQualification):
        ...
        async with self._cache_lock:
            ...
            self._cache_timestamps[symbol] = datetime.now(UTC)
