...
class BaseFormatHandler(ABC):
    ...
    def __init__(
        ...
        config: FormatHandlerConfig | None = None,
    ):
        """
    ...
    @abstractmethod
    def process(self, data: Any, symbols: list[str], source: str) -> list[dict[str, Any]]:
        """
    ...
    def _should_skip_duplicate(
        self, symbol: str, year: int, period: str, statement_type: str = "income_statement"
    ) -> bool:
        """
    ...
    def _parse_filing_date(self, date_value: Any) -> Any | None:
        """
