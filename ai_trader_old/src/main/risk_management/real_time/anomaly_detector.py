...
class RealTimeAnomalyDetector:
    ...
    async def update_market_data(
        self, symbol: str, price: float, volume: int, timestamp: datetime | None = None
    ):
    ...
    def get_anomaly_statistics(self) -> dict[str, Any]:
        ...
        recent_24h = [
            ...
            if (datetime.now(UTC) - a.timestamp).total_seconds() < 86400
        ]
        ...
        for anomaly_type in AnomalyType:
            type_counts[anomaly_type.value] = len(
                [a for a in recent_24h if a.anomaly_type == anomaly_type]
            )
        ...
        return {
            ...
            "avg_detection_confidence": (
                np.mean([a.model_confidence for a in recent_24h]) if recent_24h else 0
            ),
    ...
    def get_current_market_regime(self) -> MarketRegime | None:
    ...
    def get_buffer_status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "symbol_buffer_sizes": {
                symbol: len(self.price_buffers[symbol]) for symbol in self.price_buffers
            },
    ...
    def get_detector_status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "regime_detector": {
                ...
                "current_regime": (
                    self.regime_detector.get_current_regime().name
                    if self.regime_detector.get_current_regime()
                    else None
                ),
