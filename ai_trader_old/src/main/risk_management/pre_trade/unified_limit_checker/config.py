...
class ActionConfig:
    ...
    severity_action_map: dict[ViolationSeverity, LimitAction] = field(
...
class LimitTypeConfig:
    ...
    default_action: LimitAction = LimitAction.ALERT
    check_frequency_seconds: int | None = None  # None means check on every request
...
def get_default_config() -> LimitConfig:
    ...
    config.limit_type_configs = {
        LimitType.POSITION_SIZE: LimitTypeConfig(
            ...
            custom_settings={"check_notional": True, "include_pending_orders": True},
        ),
        ...
        LimitType.TRADING_VELOCITY: LimitTypeConfig(
            ...
            custom_settings={"time_window_minutes": 60, "count_modifications": False},
        ),
        LimitType.CONCENTRATION: LimitTypeConfig(
            ...
            custom_settings={"group_by_sector": True, "include_correlated": True},
        ),
        LimitType.VOLATILITY: LimitTypeConfig(
            ...
            custom_settings={"lookback_days": 20, "use_garch": False},
        ),
        LimitType.VAR_UTILIZATION: LimitTypeConfig(
            ...
            custom_settings={"confidence_level": 0.95, "horizon_days": 1},
        ),
        LimitType.LEVERAGE: LimitTypeConfig(
            enabled=True,
            default_threshold=2.0,  # 2x max leverage
            default_action=LimitAction.BLOCK_TRADE,
            custom_settings={"include_derivatives": True, "gross_leverage": True},
        ),
    }
