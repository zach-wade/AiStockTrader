...
from .types import BufferConfig, ConnectionConfig, MessagePriority
...
class WebSocketManager:
    ...
    def get_client(self, name: str) -> OptimizedWebSocketClient | None:
    ...
    def get_overall_stats(self) -> dict[str, Any]:
        ...
        with self._lock:
            return {
                ...
                "clients": {name: client.get_stats() for name, client in self.clients.items()},
            }
...
async def create_optimized_websocket(
    ...
    """
    connection_config = ConnectionConfig(url=url, headers=headers or {}, auth_data=auth_data)
