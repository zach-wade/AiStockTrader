...
def create_market_cap_filter(min_cap: float, max_cap: float | None = None) -> Filter:
...
def create_volatility_filter(min_volatility: float, max_volatility: float | None = None) -> Filter:
...
def create_beta_filter(min_beta: float, max_beta: float | None = None) -> Filter:
...
def create_dividend_yield_filter(min_yield: float, max_yield: float | None = None) -> Filter:
...
def create_pe_ratio_filter(min_pe: float, max_pe: float | None = None) -> Filter:
