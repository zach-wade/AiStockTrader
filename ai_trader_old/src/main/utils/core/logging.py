...
def setup_training_logger(level: str = "INFO", log_dir: Path | None = None) -> logging.Logger:
    """
    ...
    return setup_logging(level=level, log_file=log_file, component="training_pipeline")
