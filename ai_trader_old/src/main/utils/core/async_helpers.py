...
async def process_in_batches(
    items: list[Any], worker_coro: Callable[[Any], Coroutine], batch_size: int
):
    """
...
async def gather_with_exceptions(
    *coros: Coroutine[Any, Any, T], return_exceptions: bool = True
) -> list[T | Exception]:
    """
...
async def timeout_coro(
    coro: Coroutine[Any, Any, T], timeout_seconds: float, timeout_msg: str | None = None
) -> T:
    """
