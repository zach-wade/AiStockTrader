...
class ConfigSchema:
    ...
    def add_optional_key(
        self, key: str, key_type: type = None, default_value: Any = None, validator: Callable = None
    ):
...
def create_basic_schema() -> ConfigSchema:
    ...
    return ConfigSchema(
        ...
        type_mapping={"name": str, "description": str, "version": str},
        default_values={"description": "No description provided", "version": "1.0.0"},
    )
...
def create_database_schema() -> ConfigSchema:
    ...
    return ConfigSchema(
        ...
        validators={"port": lambda x: 1 <= x <= 65535, "pool_size": lambda x: x > 0},
        default_values={"ssl": False, "pool_size": 5},
    )
...
def create_api_schema() -> ConfigSchema:
    ...
    return ConfigSchema(
        ...
        default_values={"timeout": 30.0, "retries": 3, "rate_limit": 100},
    )
