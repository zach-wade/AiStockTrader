...
class MetricsExporter:
    ...
    def export_to_json(self, metrics: dict[str, Any], filename: str | None = None) -> str:
        """
    ...
    def export_to_csv(self, metrics: dict[str, Any], filename: str | None = None) -> str:
        """
    ...
    def export_to_html(self, metrics: dict[str, Any], filename: str | None = None) -> str:
        """
    ...
    def export_to_influxdb(
        self, metrics: dict[str, Any], measurement: str = "ai_trader"
    ) -> dict[str, Any]:
        """
        ...
        return {"measurement": measurement, "tags": tags, "fields": fields, "time": timestamp}
...
class BatchMetricsExporter:
    ...
    def __init__(self, exporter: MetricsExporter | None = None):
        """
    ...
    def add_metrics(self, metrics: dict[str, Any], timestamp: datetime | None = None):
        ...
        self.batch.append({"timestamp": timestamp, "metrics": metrics})
