...
def get_global_monitor() -> PerformanceMonitor:
    ...
    if _global_monitor is None:
        ...
        logger.info(
            f"Created global performance monitor (enhanced={'enabled' if db_pool else 'disabled'})"
        )
...
async def timer(name: str, tags: dict[str, str] | None = None):
...
def sync_timer(name: str, tags: dict[str, str] | None = None):
