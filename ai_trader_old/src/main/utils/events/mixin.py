...
class CallbackMixin:
    ...
    def emit(self, event_type: str, data: Any = None, **kwargs) -> asyncio.Task:
        ...
        return asyncio.create_task(self._callback_manager.emit_event(event_type, data, **kwargs))
    ...
    def add_middleware(self, before: Callable | None = None, after: Callable | None = None):
