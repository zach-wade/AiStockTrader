...
class IngestionError(DataPipelineError):
    ...
    def __init__(
        self, message: str, source: str | None = None, data_type: str | None = None, **kwargs
    ):
        self.source = source
...
class ProcessingError(DataPipelineError):
    ...
    def __init__(
        self, message: str, stage: str | None = None, records_affected: int | None = None, **kwargs
    ):
        self.stage = stage
...
class OrderExecutionError(TradingError):
    ...
    def __init__(
        self, message: str, order_id: str | None = None, symbol: str | None = None, **kwargs
    ):
...
def migrate_exception(old_exception: Exception) -> AITraderException:
    ...
    return new_class(str(old_exception), original_error=old_exception)
