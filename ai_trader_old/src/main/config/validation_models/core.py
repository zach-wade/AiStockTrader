...
class ApiKeysConfig(BaseModel):
    ...
    alpha_vantage: AlphaVantageConfig | None = None
    benzinga: BenzingaConfig | None = None
    finnhub: FinnhubConfig | None = None
    fred: FredConfig | None = None
    news_api: NewsApiConfig | None = None
    ...
    def validate_required_apis(self):
        ...
        secondary_sources = [self.polygon, self.alpha_vantage, self.benzinga]
        ...
        if not any(secondary_sources):
            ...
            logger.warning(
                "No secondary data sources configured - system will rely solely on Alpaca"
            )
