...
class InferenceFeatureCache:
    ...
    def __init__(self, cache_ttl_seconds: Optional[int] = None):
        ...
        logger.debug(
            f"InferenceFeatureCache initialized with TTL: {self._cache_ttl_seconds}s, using MarketDataCache"
        )
    ...
    async def set_cached_features(self, cache_key: str, features_dict: Dict[str, float]):
        ...
        try:
            ...
            success = await cache.set(
                CacheType.FEATURES, cache_key, features_dict, self._cache_ttl_seconds
            )
