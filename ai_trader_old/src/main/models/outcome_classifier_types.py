...
class OutcomeLabel(Enum):
    ...
    @classmethod
    def from_return(
        cls, return_pct: float, thresholds: Optional[Dict[str, float]] = None
    ) -> "OutcomeLabel":
        """
        ...
        if thresholds is None:
            thresholds = {"strong_win": 0.05, "win": 0.02, "loss": -0.02, "strong_loss": -0.05}
...
class LabelingConfig:
    ...
    # Return thresholds
    return_thresholds: Dict[str, float] = field(
