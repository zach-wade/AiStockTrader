...
class MeanReversionStrategy(BaseStrategy):
    ...
    def _generate_signal(self, indicators: dict[str, float]) -> dict[str, Any]:
        ...
        if (
            ...
            and rsi < 35
            and band_position < 0.2
            and volume_ratio > 0.8
        ):  # Ensure decent volume
        ...
        # Exit conditions
        elif z_score > self.exit_threshold or rsi > 65 or band_position > 0.8:
        ...
        # Hold
            ...
            return {"action": 0, "reason": "no_clear_signal"}  # No signal
...
async def main():
    ...
    if signals:
        ...
        for signal in signals:
            print(
                f"  {signal['symbol']}: BUY at ${signal['price']:.2f} "
