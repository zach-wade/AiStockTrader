...
class TestQuantityCreation:
    ...
    def test_create_quantity_with_decimal(self):
        ...
        assert quantity == Decimal("100.50")
    ...
    def test_extreme_precision(self):
        ...
        quantity = Decimal("100.123456789123456789")
        assert quantity == Decimal("100.123456789123456789")
...
class TestQuantityProperties:
    ...
    def test_value_property(self):
        ...
        assert quantity == Decimal("123.45")
...
class TestQuantityValidation:
    ...
    def test_is_long(self):
        ...
        long_position = Decimal("100")
        short_position = Decimal("-100")
        zero_position = Decimal("0")
...
class TestQuantityArithmetic:
    ...
    def test_subtract_negative_quantity(self):
        ...
        result = qty1.subtract(qty2)
        assert result == Decimal("150")  # 100 - (-50) = 150
    ...
    def test_abs_method(self):
        ...
        assert positive.abs() == Decimal("100")
        assert negative.abs() == Decimal("100")
...
class TestQuantitySplitting:
    ...
    def test_split_with_remainder(self):
        ...
        assert parts[0] == Decimal("34")
        assert parts[1] == Decimal("33")
        assert parts[2] == Decimal("33")
    ...
    def test_split_with_decimals(self):
        ...
        assert parts[0] == Decimal("50.5")
        assert parts[1] == Decimal("50")

        total = sum(part for part in parts)
        assert total == Decimal("100.5")
...
class TestQuantityRounding:
    ...
    def test_round_to_zero_decimal_places(self):
        ...
        quantity = Decimal("100.678")

        rounded = quantity.round(0)
        assert rounded == Decimal("100")  # Rounds down
        assert isinstance(rounded, Quantity)

    def test_round_to_two_decimal_places(self):
        """Test rounding to 2 decimal places."""
        quantity = Decimal("100.12678")

        rounded = quantity.round(2)
        assert rounded == Decimal("100.12")  # Rounds down
    ...
    def test_round_negative_quantity(self):
        ...
        rounded = quantity.round(0)
        assert rounded == Decimal("-100")  # Rounds towards zero (up for negative)

    def test_round_down_behavior(self):
        """Test that rounding uses ROUND_DOWN."""
        quantity1 = Decimal("100.999")
        quantity2 = Decimal("100.111")

        assert quantity1.round(0) == Decimal("100")
        assert quantity2.round(0) == Decimal("100")
...
class TestQuantityOperators:
    ...
    def test_abs_operator(self):
        ...
        assert abs(positive) == Decimal("100")
        assert abs(negative) == Decimal("100")
...
class TestQuantityEdgeCases:
    ...
    def test_very_large_quantity(self):
        ...
        large_qty = Decimal("999999999999999999")
        assert large_qty == Decimal("999999999999999999")
    ...
    def test_very_small_quantity(self):
        ...
        assert small_qty == Decimal("0.00000001")
    ...
    def test_scientific_notation(self):
        ...
        quantity = "1.5E+3"
        assert quantity == Decimal("1500")

        quantity = "1.5E-3"
        assert quantity == Decimal("0.0015")
    ...
    def test_immutability(self):
        ...
        new_qty = quantity.add(Decimal("50"))
    ...
    def test_chain_operations(self):
        ...
        result = quantity.add(Decimal("50")).multiply(2).divide(3)
    ...
    def test_zero_arithmetic(self):
        ...
        # Adding zero
        assert hundred.add(zero) == Decimal("100")
        assert zero.add(hundred) == Decimal("100")

        # Subtracting zero
        assert hundred.subtract(zero) == Decimal("100")
        assert zero.subtract(hundred) == Decimal("-100")
