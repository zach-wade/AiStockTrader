...
from main.utils.alerting.alerting_service import (
    AlertingService, 
    AlertPriority, 
    AlertChannel
)
...
class TradingMonitor:
    ...
    async def monitor_portfolio_drawdown(
        self, 
        current_value: float, 
        peak_value: float
    ):
...
async def main():
    ...
    await monitor.monitor_portfolio_drawdown(
        current_value=95000,
        peak_value=100000
    )
    ...
    await monitor.monitor_position_size(
        symbol="AAPL",
