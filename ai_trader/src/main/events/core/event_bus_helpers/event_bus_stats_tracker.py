...
class EventBusStatsTracker:
    ...
    def get_stats(self, queue_size: int = 0, history_size: int = 0, dlq_size: int = 0) -> Dict[str, Any]:
        """
        ...
        return {
            ...
            'processing_time': self.metrics.get_metric_value("event_bus.processing_time") if hasattr(self.metrics, 'get_metric_value') else 0
        }