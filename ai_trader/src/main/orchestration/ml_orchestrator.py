...
from main.trading_engine.core.trading_system import TradingSystem, TradingMode
...
from main.utils.core import setup_logging, get_logger
...
class MLOrchestrator:
    ...
    def __init__(self, config: Any, db_pool=None, data_source_manager=None, event_bus=None):
        ...
        self.signal_handler: Optional[UnifiedSignalHandler] = None
        self.alert_manager: Optional[AlertManager] = None
        
        # ML components
        self.ml_service: Optional[MLTradingService] = None
    ...
    async def _check_system_health(self):
        ...
        try:
            ...
            if self.ml_service and self.last_prediction_time:
                time_since_prediction = (datetime.now(timezone.utc) - self.last_prediction_time).seconds
        ...
        try:
            ...
            return {
                'orchestrator': {
                    ...
                    'last_prediction_time': status.last_prediction_time.isoformat() if status.last_prediction_time else None,
