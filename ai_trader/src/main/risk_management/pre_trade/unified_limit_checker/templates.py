...
from .types import LimitType, LimitScope, LimitAction, ComparisonOperator
...
class LimitTemplates:
    ...
    @staticmethod
    def create_position_size_limit(limit_id: str, max_position_pct: float,
                                 scope_filter: Optional[Dict] = None) -> LimitDefinition:
...
def create_basic_portfolio_limits(max_position_pct: float = 10.0,
                                max_drawdown_pct: float = 20.0,
                                max_leverage: float = 2.0) -> List[LimitDefinition]:
...
def create_comprehensive_portfolio_limits(max_position_pct: float = 5.0,
                                        max_drawdown_pct: float = 15.0,
                                        max_leverage: float = 1.5,
                                        max_volatility_pct: float = 25.0,
                                        max_correlation: float = 0.8) -> List[LimitDefinition]:
