...
from .helpers import validate_table_column, validate_filter_keys, sanitize_order_by_columns
...
class BaseRepository(
    ...
    def _build_select_query(self, query_filter: QueryFilter) -> tuple:
        ...
        if query_filter.symbols:
            placeholders = [f"${i}" for i in range(param_count, param_count + len(query_filter.symbols))]
