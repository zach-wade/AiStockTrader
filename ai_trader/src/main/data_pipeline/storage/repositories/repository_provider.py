...
class RepositoryProvider(IRepositoryProvider):
    ...
    def refresh_repository(self, name: str) -> Optional[Any]:
    ...
    def _get_repository(self, name: str) -> Optional[Any]:
...
class RepositoryServiceLocator:
    ...
    _provider: Optional[RepositoryProvider] = None
    ...
    @classmethod
    def get_provider(cls) -> Optional[RepositoryProvider]:
