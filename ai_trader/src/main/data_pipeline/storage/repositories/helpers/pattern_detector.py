...
class PatternDetector:
    ...
    async def _get_price_data(
        ...
        results = await self.db_adapter.fetch_all(
            query, symbol.upper(), start_date, end_date
        )
    ...
    def _detect_triangle_ascending(self, df: pd.DataFrame) -> Optional[Dict[str, Any]]:
    ...
    def _detect_triangle_descending(self, df: pd.DataFrame) -> Optional[Dict[str, Any]]:
    ...
    def _detect_breakout_resistance(self, df: pd.DataFrame) -> Optional[Dict[str, Any]]:
    ...
    def _detect_breakdown_support(self, df: pd.DataFrame) -> Optional[Dict[str, Any]]:
