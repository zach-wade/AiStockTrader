...
from typing import Any, Callable, Dict, List, Optional, TypeVar, Generic, AsyncGenerator
import time

from main.utils.core import get_logger, chunk_list
...
class BatchProcessor(Generic[T, R]):
    ...
    async def process_batch(
        ...
        return {
            ...
            'statistics': {
                ...
                'items_per_second': self.total_processed / self.processing_time if self.processing_time > 0 else 0
            }
        }
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'success_rate': self.total_succeeded / self.total_processed if self.total_processed > 0 else 0,
            'processing_time': self.processing_time,
