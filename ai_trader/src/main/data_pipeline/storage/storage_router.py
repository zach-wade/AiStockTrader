...
class StorageRouter(IStorageRouter):
    ...
    def route_query(self, 
                   ...
                   prefer_performance: bool = False) -> RoutingDecision:
        """
        ...
        """
        # Calculate data age
        end_date = query_filter.end_date or datetime.now(timezone.utc)
        start_date = query_filter.start_date
        
        if start_date:
            data_age_days = (datetime.now(timezone.utc) - ensure_utc(start_date)).days
    ...
    async def execute_hot_query(self,
                               repository_name: str,
                               method_name: str,
                               query_filter: QueryFilter,
                               **kwargs) -> Any:
    ...
    async def execute_cold_query(self,
                                repository_name: str,
                                method_name: str,
                                query_filter: QueryFilter,
                                **kwargs) -> Any:
    ...
    def get_routing_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'hot_percentage': (
                self.routing_stats['hot_queries'] / total_queries * 100 
