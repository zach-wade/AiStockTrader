...
class DeduplicationService:
    ...
    def __init__(
        ...
        self._db_cache_timestamp: Optional[datetime] = None
    ...
    async def _check_id_duplicate(self, record_id: str) -> bool:
        ...
        async with self._cache_lock:
            ...
            self._cache_timestamps[f"id_{id_hash}"] = datetime.now(timezone.utc)
    ...
    async def _check_hash_duplicate(self, content_hash: str) -> bool:
        ...
        async with self._cache_lock:
            ...
            self._cache_timestamps[f"hash_{content_hash}"] = datetime.now(timezone.utc)
