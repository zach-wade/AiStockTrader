...
class MetricExtractionService:
    ...
    def __init__(self, config: Optional[MetricExtractionConfig] = None):
        """
        ...
        self._revenue_keys = [
            ...
            'total_revenue', 'operating_revenue', 'revenue', 'revenues'
        ]
    ...
    def _extract_float_metric(self, data: Dict[str, Any], possible_keys: List[str]) -> Optional[float]:
        """
    ...
    def _extract_eps_metric(self, data: Dict[str, Any], possible_keys: List[str]) -> Optional[float]:
        """
    ...
    def validate_metrics(self, record: Dict[str, Any]) -> bool:
        ...
        financial_metrics = [
            ...
            'eps_basic', 'eps_diluted', 'current_assets', 'current_liabilities',
            'stockholders_equity'
        ]
        ...
        if not has_metric and self.config.strict_validation:
            logger.warning(f"Record for {record.get('symbol')} {record.get('year')} {record.get('period')} has no financial metrics")
