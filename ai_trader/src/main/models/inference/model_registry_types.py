...
class ModelVersion:
    ...
    metadata: Dict[str, Any] = field(default_factory=dict) # Additional metadata (e.g., preprocessing steps, data sources)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if data['model_file_path']:
            data['model_file_path'] = str(data['model_file_path']) # Convert Path to string for JSON
        return data
