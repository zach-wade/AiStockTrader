...
from main.models.inference.model_registry_helpers.traffic_router import TrafficRouter # For routing info in deployment config
...
class ModelAnalyticsService:
    ...
    def compare_model_versions(self, model_id: str, version1: str, version2: str) -> Dict[str, Any]:
        ...
        if not v1_obj or not v2_obj:
            logger.error(f"One or both versions not found for model {model_id}: v1='{version1}', v2='{version2}'. Cannot compare.")
