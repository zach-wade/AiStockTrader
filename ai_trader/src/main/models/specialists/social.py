...
class SocialSpecialist(BaseCatalystSpecialist):
    ...
    def __init__(self, config: Any):
        ...
        # Platform weights
        self.platform_weights = self.specialist_config.get('platform_weights', {
            'reddit': 0.4,
            'twitter': 0.3,
            'stocktwits': 0.2,
            'discord': 0.1
    ...
    def extract_specialist_features(self, catalyst_features: Dict[str, Any]) -> Dict[str, float]:
        ...
        try:
            ...
            features['engagement_quality'] = self._calculate_engagement_quality(
                features
            )
            features['catalyst_strength'] = self._calculate_social_catalyst_strength(
                features
            )
