...
class TrainingPipelineRunner:
    ...
    def __init__(self, args: Optional[argparse.Namespace] = None):
        ...
        self.results = PipelineResults(
            ...
            config_snapshot={'cli_args': self.pipeline_args.__dict__, 'system_config_version': self.system_config.get('version', 'unknown')}
        )
    ...
    async def run(self) -> int:
        ...
        try:
            ...
            self.results.update_status("completed" if not self.results.errors else "completed_with_errors")
            ...
            # Save final results
            reports_dir = Path(self.system_config.get('paths', {}).get('reports', 'reports/training'))
