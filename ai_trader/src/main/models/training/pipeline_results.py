...
class PipelineResults:
    ...
    def get_best_model(self, metric: str = 'sharpe_ratio', higher_better: bool = True) -> Optional[Tuple[str, ModelResult]]:
    ...
    def print_summary(results: PipelineResults):
        ...
        if results.models:
            ...
            metric_cols = [
                ...
                if col not in display_cols and col != 'training_time'
            ]
