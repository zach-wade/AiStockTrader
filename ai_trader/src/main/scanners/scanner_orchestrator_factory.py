...
from main.interfaces.scanners import IScannerOrchestrator, IScanner, ScannerConfig
from main.scanners.scanner_orchestrator import (
    ScannerOrchestrator,
    OrchestrationConfig
)
...
class ScannerOrchestratorFactory:
    ...
    async def create_test_orchestrator(
        event_bus: Optional[IEventBus] = None,
        scanners: Optional[Dict[str, IScanner]] = None
    ) -> IScannerOrchestrator:
        """
    ...
    @staticmethod
    def _build_orchestration_config(
