...
class ScannerMetricsCollector:
    ...
    async def record_scan_completion(
        ...
        async with self._lock:
            ...
            metrics['last_scan_time'] = datetime.now(timezone.utc)
    ...
    async def get_metrics(self, scanner_name: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def reset_metrics(self, scanner_name: Optional[str] = None):
        """
