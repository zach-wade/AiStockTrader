...
class ScannerFactoryV2:
    ...
    def __init__(
        ...
        self._storage_router: Optional[IStorageRouter] = None
        # Storage executor removed - file doesn't exist
        self._repository_provider: Optional[RepositoryProvider] = None
        self._scanner_repository: Optional[IScannerRepository] = None
    ...
    def _initialize_storage_system(self):
        ...
        if self._storage_router is None:
            ...
            from main.data_pipeline.storage.repositories.repository_types import RepositoryConfig, ValidationLevel
...
_scanner_factory_v2: Optional[ScannerFactoryV2] = None
...
def get_scanner_factory_v2(
    ...
    needs_new = (
        _scanner_factory_v2 is None or
        _scanner_factory_v2.db_adapter != db_adapter or
        _scanner_factory_v2.event_bus != event_bus
    )
