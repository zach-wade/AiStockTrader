...
class RiskConfig:
    ...
    var_methods_enabled: List[VaRMethod] = field(default_factory=lambda: [
    ...
    parametric_dof: Optional[float] = None  # degrees of freedom for t-distribution
    ...
    def _validate_config(self):
        ...
        if self.volatility_lookback_window <= 0:
            raise ValueError(f"Invalid volatility lookback window: {self.volatility_lookback_window}")
