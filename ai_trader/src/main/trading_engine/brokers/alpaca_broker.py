...
from main.trading_engine.brokers.broker_interface import (
    BrokerInterface, BrokerConnectionError, OrderSubmissionError,
...
class AlpacaBroker(BrokerInterface):
    ...
    async def submit_order(self, order: Order) -> str:
        ...
        try:
            ...
            self._track_event("order_submitted", {
    ...
    async def get_account_info(self) -> AccountInfo:
        ...
        try:
            ...
            return AccountInfo(
                ...
                positions_value=Decimal(str(account.long_market_value)) + Decimal(str(account.short_market_value)),
