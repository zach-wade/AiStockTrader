...
from .types import StateConfig, StorageBackend, SerializationFormat
from .backends import StorageBackendInterface, MemoryBackend, RedisBackend, FileBackend
...
class StateManager:
    ...
    def _init_serializers(self) -> None:
        ...
        from main.utils.core import to_json, from_json
        ...
        self._serializers[SerializationFormat.BINARY] = lambda obj: obj if isinstance(obj, bytes) else str(obj).encode()
    ...
    async def get(self, 
                 ...
                 backend: Optional[StorageBackend] = None) -> Optional[Any]:
        """
    ...
    async def set(self, 
                 ...
                 serialization: Optional[SerializationFormat] = None) -> bool:
        """
        Set state value.
    ...
    async def delete(self, 
                    key: str,
                    namespace: str = "default",
                    backend: Optional[StorageBackend] = None) -> bool:
        """
        Delete state value.
    ...
    async def keys(self, 
                  pattern: str = "*",
                  namespace: str = "default",
                  backend: Optional[StorageBackend] = None) -> List[str]:
