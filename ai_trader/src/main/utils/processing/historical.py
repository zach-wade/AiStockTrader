...
from main.utils.core import get_trading_days_between, get_market_hours, is_trading_day
...
class ProcessingUtils:
    ...
    @staticmethod
    def calculate_optimal_parallel(sources: List[str], config: Optional[DictConfig] = None) -> int:
        """
...
class DataCalculationUtils:
    ...
    @staticmethod
    def calculate_expected_data_points(start: datetime, 
                                     end: datetime, 
                                     interval: str,
                                     market_hours_only: bool = True) -> int:
        """
        ...
        if interval == "1day":  # FIXED: Use string literals
            ...
            if not market_hours_only:
                ...
                # Market hours only
                return DataCalculationUtils._calculate_market_hours_points(
                    start, end, interval
                )
    ...
    @staticmethod
    def _calculate_market_hours_points(start: datetime, 
                                     end: datetime, 
                                     interval: str) -> int:
    ...
    @staticmethod
    def estimate_download_size(symbols: List[str],
                             intervals: List[str],
...
class DebugUtils:
    ...
    @staticmethod
    def format_gap_summary(gaps: List[Tuple[datetime, datetime]], 
                          max_gaps: int = 10) -> str:
        """
