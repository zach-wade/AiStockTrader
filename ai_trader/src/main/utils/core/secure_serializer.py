...
class SecureSerializer:
    ...
    ALLOWED_CLASSES = {
        ...
        'main.models.common': {
            'MarketData', 'Quote', 'Position', 'Order', 'Trade',
        ...
        try:
            ...
            if self._validate_object_for_pickle(obj):
                try:
                    ...
                    raise SecurityError(f"Pickle serialization failed: {str(e)}")
            else:
            ...
            raise SecurityError(f"Serialization failed: {str(e)}")
        ...
        try:
            ...
            if data.startswith(b'JSON:'):
                ...
                try:
                    ...
                    raise SecurityError(f"Invalid JSON data: {str(e)}")
            ...
            raise SecurityError(f"Deserialization failed: {str(e)}")
    ...
    def _safe_pickle_loads(self, data: bytes) -> Any:
        ...
        try:
            ...
            raise SecurityError(f"Pickle deserialization failed: {str(e)}")
...
def migrate_unsafe_pickle(unsafe_data: bytes, validate_result: bool = True) -> bytes:
    ...
    try:
        ...
        raise SecurityError(f"Failed to migrate unsafe pickle data: {str(e)}")