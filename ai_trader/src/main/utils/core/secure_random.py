...
class SecureRandom:
    ...
    def choice(self, sequence: List) -> Union[int, float, str]:
        """
    ...
    def secure_numpy_uniform(self, low: float = 0.0, high: float = 1.0, 
    ...
    def secure_numpy_normal(self, loc: float = 0.0, scale: float = 1.0,
                          size: Optional[Union[int, Tuple[int, ...]]] = None) -> Union[float, np.ndarray]:
        """
...
def secure_choice(sequence: List) -> Union[int, float, str]:
...
def secure_numpy_uniform(low: float = 0.0, high: float = 1.0, 
                        size: Optional[Union[int, Tuple[int, ...]]] = None) -> Union[float, np.ndarray]:
...
def secure_numpy_normal(loc: float = 0.0, scale: float = 1.0,
                       size: Optional[Union[int, Tuple[int, ...]]] = None) -> Union[float, np.ndarray]:
...
class SecureRandomMigrationHelper:
    ...
    @staticmethod
    def replace_numpy_random_uniform(low: float = 0.0, high: float = 1.0, 
                                   size: Optional[Union[int, Tuple[int, ...]]] = None) -> Union[float, np.ndarray]:
        """
        ...
        with cryptographically secure alternative.
        """
        logger.info(f"SECURITY: Using secure random instead of np.secure_uniform({low}, {high}, {size})")
        return secure_numpy_uniform(low, high, size)
    
    @staticmethod
    def replace_numpy_random_normal(loc: float = 0.0, scale: float = 1.0,
                                  size: Optional[Union[int, Tuple[int, ...]]] = None) -> Union[float, np.ndarray]:
        """
        ...
        with cryptographically secure alternative.
        """
        logger.info(f"SECURITY: Using secure random instead of secure_numpy_normal({loc}, {scale}, {size})")
