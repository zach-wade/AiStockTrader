...
async def safe_json_write(file_path: Union[str, Path], data: Dict[str, Any]) -> bool:
    """
...
def clean_old_files(directory: Union[str, Path], days_old: int, 
                   pattern: str = "*") -> int:
    """
...
def copy_with_backup(src: Union[str, Path], dst: Union[str, Path], 
...
async def read_file_chunks(file_path: Union[str, Path], chunk_size: int = 8192):
    """
