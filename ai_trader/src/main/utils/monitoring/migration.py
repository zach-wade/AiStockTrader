...
from .types import MetricType, AlertLevel
...
class MigrationMonitor(PerformanceMonitor):
    ...
    def __init__(
        ...
        enable_enhanced: Optional[bool] = None
    ):
        """
        ...
        self.enhanced_monitor: Optional[EnhancedMonitor] = None
    ...
    async def get_metric_series(
        ...
        """
        if self.enhanced_monitor:
            return await self.enhanced_monitor.get_metric_series(
                name, period_minutes, tags
            )
        else:
...
def should_use_enhanced(db_pool: Optional[DatabasePool] = None) -> bool:
