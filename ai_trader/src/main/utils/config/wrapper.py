...
from .sources import ConfigFormat, ConfigSource, ConfigSourceType, create_file_source, create_env_source, create_dict_source
from .loaders import load_from_file, load_from_env, load_from_dict
...
class ConfigurationWrapper:
    ...
    def __init__(self, 
                 config_source: Optional[Union[str, Dict[str, Any]]] = None,
    ...
    def _find_changes(self, original: Dict[str, Any], current: Dict[str, Any], prefix: str, changes: Dict[str, Any]):
