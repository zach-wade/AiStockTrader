...
from .sources import ConfigFormat, ConfigSource, ConfigSourceType, detect_config_format
from .loaders import load_from_file, load_from_env
...
class ConfigPersistence:
    ...
    def save_to_file(self, file_path: str, format: Optional[ConfigFormat] = None):
        """
    ...
    def backup_configuration(self, backup_path: str, format: Optional[ConfigFormat] = None):
        """
    ...
    def restore_from_backup(self, backup_path: str, format: Optional[ConfigFormat] = None):
        """
    ...
    def export_config(self, export_path: str, format: Optional[ConfigFormat] = None, include_metadata: bool = True):
        """
    ...
    def import_config(self, import_path: str, format: Optional[ConfigFormat] = None, merge: bool = True):
        """
