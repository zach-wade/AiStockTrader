...
from typing import (
    Optional, Callable, Any, Dict, List, Union, Tuple, 
    Type, Awaitable, TypeVar, Generic
)
...
class RetryConfig:
    ...
    stop_if: Optional[Callable[[Exception], bool]] = None
...
@asynccontextmanager
async def error_recovery_context(config: Optional[RetryConfig] = None):
    """
...
class BulkRetryManager:
    ...
    async def execute_bulk_operation(
        ...
        tasks = [
            process_item_with_retry(item, i) 
