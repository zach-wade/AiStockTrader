...
class UnifiedHealthChecker:
    ...
    async def check_market_data_tables(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            return False, f"Market data table check failed: {str(e)}"
        ...
        try:
            ...
            if missing_tables:
                ...
                row_count = await conn.fetchval(
                    "SELECT COUNT(*) FROM scanner_qualifications"
                )
                return True, f"Scanner tables exist (current qualifications: {row_count})"
                
        except Exception as e:
            return False, f"Scanner table check failed: {str(e)}"
    ...
    async def check_data_lake_structure(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            if missing_dirs:
                ...
                market_data_files = len(list((self.data_lake_path / 'raw/market_data').rglob('*.parquet')))
                return True, f"Data lake structure intact ({market_data_files} market data files)"
                
        except Exception as e:
            return False, f"Data lake structure check failed: {str(e)}"
    ...
    async def check_scanner_layers(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            return False, f"Scanner layer check failed: {str(e)}"
    ...
    async def check_feature_pipeline(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            try:
                from main.feature_pipeline.calculators.microstructure import MicrostructureCalculator
                calculator_count += 1
            except:
                pass
            ...
            return False, f"Feature pipeline check failed: {str(e)}"
    ...
    async def check_event_system(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            return False, f"Event system check failed: {str(e)}"
    ...
    async def check_data_flow_path(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            # Data Lake storage
            try:
                from main.data_pipeline.storage.archive import Archive
            ...
            return False, f"Data flow check failed: {str(e)}"
    
    async def check_backfill_system(self) -> Tuple[bool, str]:
        """Check backfill processor health."""
        try:
            from main.data_pipeline.backfill import BackfillProcessor, BackfillSessionManager
            from main.data_pipeline.historical.orchestrator import HistoricalOrchestrator
            
            return True, "Backfill system components available"
            
        except Exception as e:
            return False, f"Backfill system check failed: {str(e)}"
    ...
    async def run_all_checks(self):
        ...
        for category_name, checks in check_categories:
            ...
            self.results[category_key] = {
                check: result for check, result in category_results
            }
