...
LOOKBACK_DAYS = 60
CANDIDATE_PAIRS = [("AAPL", "MSFT"), ("GOOGL", "GOOG"), ("ADBE", "CRM")] # This would come from a larger screening process
...
def calculate_hedge_ratios(data_provider: HistoricalDataProvider, pairs: list) -> list:
    ...
    for symbol1, symbol2 in pairs:
        ...
        tradable_pairs_with_ratios.append({
...
def main():
    ...
    output_data = {
        ...
        "tradable_pairs": calculated_pairs
    }
