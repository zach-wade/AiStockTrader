...
from main.feature_pipeline.calculators.insider_analytics import (
    InsiderAnalyticsCalculator, InsiderConfig
)
...
class TestInsiderAnalyticsCalculator(unittest.TestCase):
    ...
    def test_calculate_without_insider_data(self):
        ...
        for feature_name in feature_names:
            if feature_name in features.columns:
                self.assertTrue((features[feature_name] == 0).all() or 
                              features[feature_name].isna().all())
    ...
    def test_transaction_metrics(self):
        ...
        result = self.calculator._add_transaction_metrics(
            self.market_data.head(50), features
        )
        
        # Check that transaction metric columns are added
        expected_cols = ['insider_buy_count_30d', 'insider_sell_count_30d', 
                        'insider_net_count_30d']
    ...
    def test_sentiment_calculation(self):
        ...
        result = self.calculator._add_insider_sentiment(
            self.market_data.head(5), features
        )
    ...
    def test_moving_averages(self):
        ...
        expected_ma_cols = ['insider_sentiment_ma_30', 'insider_sentiment_ma_90', 
    ...
    def test_feature_interactions(self):
        ...
        expected_interaction_cols = ['sentiment_conviction_product', 
