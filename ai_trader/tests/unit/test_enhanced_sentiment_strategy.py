...
from main.models.common import Signal # Assuming Signal is in common
...
def test_position_sizing_adjusts_for_volatility(sentiment_strategy):
    ...
    # Act
    size_low_vol = sentiment_strategy._get_position_size("VOL_STOCK", strong_signal, low_vol_features)
    
    # Case 2: High volatility  
    high_vol_features = pd.DataFrame({'volatility_20d': [0.05]}) # 5% daily vol
    
    # Act
    size_high_vol = sentiment_strategy._get_position_size("VOL_STOCK", strong_signal, high_vol_features)
