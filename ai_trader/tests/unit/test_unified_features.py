...
def test_calculate_features_combines_results(sample_ohlcv_data, mock_technical_calculator, mock_regime_calculator, tmp_path: Path):
    """
...
def test_calculate_features_with_specific_calculators(sample_ohlcv_data, mock_technical_calculator, mock_regime_calculator, tmp_path: Path):
    """
    ...
    # Act
    result_df = engine.calculate_features(sample_ohlcv_data, calculators=['regime'], use_cache=False)
...
@patch('main.feature_pipeline.unified_features.pickle') # Mock the pickle library within the unified_features module
...
def test_engine_handles_calculator_error_gracefully(sample_ohlcv_data, mock_technical_calculator, mock_regime_calculator, tmp_path: Path):
    """
