...
def sample_config_file():
    ...
    return {
        'features': {
            ...
            'feature_sets': {
                'file_set': {
                    'description': 'File feature set',
                    'calculators': ['file_calculator']
                }
            }
        }
    }
...
class TestFeatureConfigInit:
    ...
    @patch('main.feature_pipeline.feature_config.get_config')
    def test_init_with_invalid_config_file(self, mock_get_config, mock_main_config, tmp_path, caplog):
...
class TestErrorHandling:
    ...
    def test_config_with_missing_calculator_params(self, mock_get_config):
        ...
        mock_get_config.return_value = {
            'features': {
                'calculators': {
                    'minimal_calc': {}  # Missing most parameters
                }
            }
        }
