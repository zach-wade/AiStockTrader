...
def test_bollinger_bands_calculation(ti_calculator, sample_price_data):
    ...
    # Act
    middle, upper, lower = ti_calculator.bollinger_bands(close_prices, period=period, std_dev=std_dev)
...
def test_calculate_all_method(ti_calculator, sample_price_data):
    ...
    expected_cols = ['rsi_14', 'macd', 'bb_middle', 'sma_20', 'ema_50', 'atr', 'obv', 'volume_ratio']
