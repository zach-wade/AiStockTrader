...
class TestRequestQueueManager:
    ...
    async def test_queue_overflow(self, queue_manager):
        ...
        with patch('main.events.handlers.feature_pipeline_helpers.request_queue_manager.record_metric') as mock_metric:
    ...
    async def test_cleanup_expired_dedup_entries(self, queue_manager):
        ...
        # Add recent entry
        tracker._recent_requests["new_request"] = datetime.now(timezone.utc)
