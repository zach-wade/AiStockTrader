...
class TestFeatureGroupConfig:
    ...
    def test_feature_group_config_equality(self):
        ...
        config1 = FeatureGroupConfig(
            name="test",
            features=["f1", "f2"],
            priority_boost=1
        )
        
        config2 = FeatureGroupConfig(
            name="test",
            features=["f1", "f2"],
            priority_boost=1
        )
        
        config3 = FeatureGroupConfig(
            name="test",
            features=["f1"],
            priority_boost=1
        )
...
class TestFeatureRequest:
    ...
    def test_feature_request_timestamp_default(self):
        ...
        # Should be recent
        time_diff = datetime.now(timezone.utc) - request.timestamp
    ...
    def test_feature_request_defaults(self):
        ...
        request = FeatureRequest(
            symbol="TSLA",
            feature_groups=[FeatureGroup.MOMENTUM]
        )
...
class TestValidateFeatureRequest:
    ...
    def test_validate_duplicate_feature_groups(self):
        ...
        request = FeatureRequest(
            symbol="AAPL",
            feature_groups=[FeatureGroup.PRICE, FeatureGroup.PRICE]
        )
