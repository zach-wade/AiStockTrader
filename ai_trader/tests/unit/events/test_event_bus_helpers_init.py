...
class TestEventBusHelpersInit:
    ...
    def test_import_from_helpers(self):
        ...
        from main.events.core.event_bus_helpers import EventBusStatsTracker
        from main.events.core.event_bus_helpers import EventHistoryManager
        from main.events.core.event_bus_helpers import DeadLetterQueueManager
    ...
    def test_submodule_structure(self):
        ...
        from main.events.core.event_bus_helpers import event_bus_stats_tracker
        from main.events.core.event_bus_helpers import event_history_manager
        from main.events.core.event_bus_helpers import dead_letter_queue_manager
    ...
    def test_import_consistency(self):
        ...
        from main.events.core.event_bus_helpers.event_bus_stats_tracker import EventBusStatsTracker as StatsTracker3
