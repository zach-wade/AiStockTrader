...
class TestFeaturePipelineHelpersInit:
    ...
    def test_import_from_helpers(self):
        ...
        # Classes
        from main.events.feature_pipeline_helpers import FeatureComputationWorker
        from main.events.feature_pipeline_helpers import FeatureGroupMapper
        from main.events.feature_pipeline_helpers import RequestQueueManager
        
        # Types
        from main.events.feature_pipeline_helpers import FeatureGroup
        from main.events.feature_pipeline_helpers import FeatureRequest
        from main.events.feature_pipeline_helpers import QueuedRequest
        
        # Functions
        from main.events.feature_pipeline_helpers import initialize_group_configs
    ...
    def test_submodule_structure(self):
        ...
        from main.events.feature_pipeline_helpers import feature_computation_worker
        from main.events.feature_pipeline_helpers import feature_group_mapper
        from main.events.feature_pipeline_helpers import feature_handler_stats_tracker
        from main.events.feature_pipeline_helpers import request_queue_manager
        from main.events.feature_pipeline_helpers import deduplication_tracker
        
        # Import split modules
        from main.events.feature_pipeline_helpers import feature_types
        from main.events.feature_pipeline_helpers import queue_types
        from main.events.feature_pipeline_helpers import feature_config
    ...
    def test_import_consistency(self):
        ...
        from main.events.handlers.feature_pipeline_helpers.feature_computation_worker import FeatureComputationWorker as Worker3
