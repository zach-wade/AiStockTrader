...
class IntegrationTestRunner:
    ...
    def _generate_summary_report(self):
        ...
        # Save report to file
        report_path = f"test_results/integration_test_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt"
...
def main():
    ...
    parser.add_argument('--test', '-t', help='Run specific test suite', choices=[
        'data', 'pipeline', 'system', 'quality', 'attribution', 'all'
    ])
