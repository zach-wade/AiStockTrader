...
class TestScannerFeatureBridgeEvents:
    ...
    async def test_alert_to_feature_mapping(
        self,
    ...
    async def test_multiple_alert_aggregation(
        self,
        test_event_bus: IEventBus,
        test_symbols
    ):
    ...
    async def test_feature_enrichment(
        self,
        test_event_bus: IEventBus,
        test_symbols
    ):
    ...
    async def test_feature_validation_and_filtering(
        self,
        test_event_bus: IEventBus,
        test_symbols
    ):
        ...
        async def mock_validate_features(features):
            ...
            if (features.get('score', 0) > 0.5 and 
                'symbol' in features and 
                'alert_type' in features):
    ...
    async def test_feature_caching_and_deduplication(
        self,
        test_event_bus: IEventBus,
        test_symbols
    ):
    ...
    async def test_cross_scanner_feature_correlation(
        self,
        test_event_bus: IEventBus,
        test_symbols
    ):
    ...
    async def test_feature_pipeline_error_handling(
        self,
        test_event_bus: IEventBus,
        test_symbols
    ):
